            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-content">
                      ...
                      <div class="column one-fifth">
                        ...
                        <h6><?php _e('Top Bar Content & Contact Number','iamd_text_domain');?></h6>
                        <div class="column one-half">
                        	<textarea id="mytheme-top-bar-content" name="mytheme[general][top-bar-content]" rows="3" style="height:auto;"><?php echo htmlspecialchars (stripslashes(dt_theme_option('general','top-bar-content')));?></textarea>
                        </div>
                        <div class="column one-half last">
                        	<textarea id="mytheme-top-bar-phoneno" name="mytheme[general][top-bar-phoneno]" rows="3" style="height:auto;"><?php echo htmlspecialchars (stripslashes(dt_theme_option('general','top-bar-phoneno')));?></textarea>
                        </div>
						<p class="note"><?php _e('Specify top bar content & phone no in above fields.','iamd_text_domain');?> </p>
                        <div class="hr"></div>

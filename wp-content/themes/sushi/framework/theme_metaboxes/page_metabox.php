               ...
               <div id="tpl-catalog">
                  ...
                  <div class="custom-box">
                      ...
                      <div class="column five-sixth last">       
                          ...
                          <input id="mytheme-catalog-post-layout" name="mytheme-catalog-post-layout" type="hidden" value="<?php echo $v;?>"/>
                          <p class="note"> <?php _e("Choose layout style for your Catalog",'iamd_text_domain');?> </p>
                      </div>      
                  ...
                  <div class="custom-box">
                      ...
                      <p class="note"> <?php _e("You can choose only certain categories to show in catalog items. ",'iamd_text_domain');?> </p>
                  </div><!-- Categories End-->                

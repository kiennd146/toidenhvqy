...
function dt_theme_default_option() {
	$general = array (
			"logo" => "true",
			"breadcrumb-delimiter" => "fa-chevron-right",
			"enable-favicon" => "true",
			...
			"top-bar-content" => "We are always here to serve you. Please take your time.",
			"top-bar-phoneno" => "888-654-3210",
			"copyright-text" => '&copy; Copyright - Sushi Restaurant - by<a href="http://themeforest.net/user/designthemes" title=""> Design Themes </a>'
	);
	...
	$specialty = array (
			...
			"menufile-url" => "http://somedomain.com/somefile.pdf",
			"404-menu-page" => "1",
	...
	$social = array (
			'social-1' => array( 'icon' => 'facebook.png', 'link' => '#'),
			'social-2' => array( 'icon' => 'twitter.png', 'link' => '#'),
			'social-3' => array( 'icon' => 'flickr.png', 'link' => '#'),
			'social-4' => array( 'icon' => 'youtube.png', 'link' => '#'),
			'social-5' => array( 'icon' => 'pinterest.png', 'link' => '#'));
...
// # --- **** dt_theme_portfolio_categorylist() *** --- ###
